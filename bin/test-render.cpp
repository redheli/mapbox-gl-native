...
int main(){
    ...
    auto assetRoot = RESOURCES "/test/fixtures/api/assets";
    DefaultFileSource fileSource(":memory:", assetRoot);
    ...
    map.getStyle().loadJSON(util::read_file(RESOURCES "/test/fixtures/api/water.json"));
    ...
    test::checkImage(RESOURCES "/test/fixtures/shared_context", frontend.render(map), 0.5, 0.1);
